...
function generateRandomSubscriptionName(ctx) { return require('../lib/username').buildUsername({ telegramUsername: ctx.from.username || String(ctx.from.id), customName: null, fallbackUsername: String(ctx.from.id) }); }
